...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://yorkittran.is-not-a.dev}{\uline{yorkittran.is-not-a.dev}} $|$ % row = 2, col = 1
...
\resumeHeadingListStart{}
  ...
  {Backend Engineer}{Apr 2023 -- Present}
  \small{Raksul is a fabless B2B platform builder. We aims to change the world by reinventing legacy industry structures with the power of the Internet.}
    \resumeHeadingListStart{}
      \resumeTrioHeading{\href{https://en.josys.com/}{Josys}}{}{Ruby on Rails, MySQL}
      \small{A complete cloud solution for IT Device & SaaS Management. Josys is leveraging HiTech to automate and simplify IT operations to support the employee lifecycle. The service has raised \$32M in a Series A round led by Global Brain. As part of a team that had over 10 members, we collaborated on building, launching, and maintaining the core service.}
    \resumeHeadingListEnd{}
  \smallskip
  ...
  \small{CodeLink is a multinational development consultancy. We approach product development through design thinking methodologies and strategies to rapidly develop digital products and platforms following a disciplined agile process.}
    \resumeHeadingListStart{}
      \resumeTrioHeading{\href{https://baonoi.ai/}{Baonoi}}{}{NodeJS, Firebase, PostgreSQL}
      \small{Baonoi is an audio news application that convert from many famous online news in Vietnam. Although still in beta phase, it has around 100 users using everyday. Mostly I focused on back-end engineering, but in this project I also have a chance to support team to do mobile stuffs.}
    \resumeHeadingListEnd{}
  \smallskip
  ...
  \small{Raksul is a fabless B2B platform builder. We aims to change the world by reinventing legacy industry structures with the power of the Internet.}
    \resumeHeadingListStart{}
      ...
      \small{Novelty is a service of Raksul launched in 2020. Novelty connects printing factory and merchandise seller to allow user direct purchase of printed items from our EC platform. Since launch, the service has grown consistently over 300\% year-over-year. I was a part of a 10 members team to build, launch and maintain the service.}

      % Cutting cost with Lambda
      \resumeTrioHeading{Cutting cost with Lambda - Hackweek Edition}{}{NodeJS, Ruby on Rails, AWS}
      \small{We built the prototype in 3 days that processing images through Lambda functions instead of Workers running on ECs. I transformed logic from back-end to Lambda functions, and handled to redirect to API Gateway. As calculation, we saved about 2000\$/month for the company if it successfully applied on other products. Therefore, we won the 1st prize of Value Award in Hackweek competition with held once a year by Raksul Headquarter.}

      % Digital Product
      \resumeTrioHeading{Digital Product}{}{NodeJS, MySQL, AWS}
      \small{Digital Product is an application that allowed venue/ads owners to create QR codes and assign it to banner ads. Then it will be delivered to many different location and the owners can track the effectiveness of them. I built the prototype alone in 4 weeks using many AWSs to create a serverless application. After 6 months of testing, it proved successfully and was integrated into a bigger product.}

      % Area Marketing
      \resumeTrioHeading{\href{https://am.raksul.com/}{Area Marketing}}{}{Ruby on Rails, VueJS, MySQL, GraphQL, Google APIs}
      \small{We were rebuilding a legacy service in modern Ruby on Rails to support further business expansion. I worked on an internal admins tool that allows our internal Raksul employees better efficiency in supporting both our customers and third-party suppliers. We aim to build a set of world-class internal tools that would allow us to scale our business without requiring a large increase in customer support team size.}

      % PRO
      \resumeTrioHeading{\href{https://pro.raksul.com/}{PRO}}{}{Ruby on Rails, VueJS, Python, MySQL}
      \small{Raksul PRO is a new business initiative that will allow other wholesale resellers to purchase and use Raksul's services. I worked in a team of 4 people to build, launch and maintain the service. Beside implementing features on back-end, I also have a chance to learn VueJS by helping create components and pages on front-end side. By using Python, we also create a crawler to make a comparison prices between competing company's products and ours.}
    \resumeHeadingListEnd{}
  \smallskip
  ...
  \small{Act Brain is the consultants, provide solutions and develop leading software systems in Japan. We have a young and enthusiastic staff, with creativity and professional qualifications.}
    \resumeHeadingListStart{}
      ...
      \small{BPO Shinjin is an internal product for managing employees by tracking time sheet, build monthly quizzes, etc. Most of the time I spent for support teamates to finish features.}
    \resumeHeadingListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
