...
\resumeHeadingListStart{}
  ...
  \small{CodeLink is a multinational development consultancy. We approach product development through design thinking methodologies and strategies to rapidly develop digital products and platforms following a disciplined agile process.}
    \resumeHeadingListStart{}
      ...
      \small{Baonoi is an audio news application that convert from many famous online news in Vietnam. Although still in beta phase, it has around 1000 users using everyday. Mostly I focused on back-end engineering, but in this project I also have a chance to support team to do mobile stuffs.}
    \resumeHeadingListEnd{}
  \smallskip
